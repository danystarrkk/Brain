...
La herramienta esa adaptada para que el ataque se pueda realizar en cualquier entorno de red.
...
Configuración de `ddddocr` en las ultimas versiones vamos a tener un problema y para solucionarlo vamos a tener que modificar el `__init__.py` de la siguiente manera:
