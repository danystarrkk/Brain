------
Ya con [[Instalar - Batcat y Lsd]] voy a dejar el contenido de los archivos ya configurado solo para copiar y pegar:
...
- Para los archivos de ethernet, vpn y target usar los siguientes links:
...
Por Ultimo vamos a ingresar lo siguiente en nuestra zshrc:
...
Ya con esto vamos a instalar la fzf.