-----
Ya listo [[Configurar - ZSH y PowerLevel10k]] comencemos con la instalación de batcat y lsd descargar los binarios e instalarlos.

Vamos a seguir agregando cosas al zsh como las siguientes:
...
Bueno burpsuite tiene un problema y para arreglarlo vamos a hacer lo siguiente que contamos en el link

[Ver Solución para Burpsuite](https://medium.com/@neat_mahogany_porcupine_191/burpsuite-no-longer-launches-after-parrot-upgrade-d1c6b17cb70d)

ya con esto solucionamos burpsuite pero se nos abre de manera desproporcionada, para solucionarlo vamos a agregar lo siguiente en nuestro .zshr:
...
También agreguemos lo siguiente en nuestro archivo bspwm:

```bash
wmname LG3D &
```

cerrar la sesión y volver a iniciar para aplicar cambios.